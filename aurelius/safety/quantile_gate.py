...
def _run_validation():
    ...
    print(f"  Missing forecast correctly blocked (fail-closed): PASS")
    ...
    # Test 7: Invalid (zero) baseline BLOCKED (fail-closed)
    ...
    print(f"  Zero baseline correctly blocked (fail-closed): PASS")
